...
export default function LoginPage() {
  ...
  const boxes = [
    ...
    },
    {
      d: 0.4,
      className:
        "absolute top-6 left-4 sm:top-10 sm:left-10 md:top-14 md:left-16 lg:top-15 lg:left-20",
      size: "h-[100px] w-[100px] sm:h-[130px] sm:w-[130px] md:h-[165px] md:w-[165px] lg:h-[200px] lg:w-[200px] opacity-90 -rotate-12",
    },
    {
      d: 0.1,
      className:
        "absolute z-2 top-[62%] left-1/2 -translate-x-1/2 -translate-y-1/2",
    ...
    },
    {
      d: 0.5,
      className:
        "absolute z-2 top-8 right-2 sm:top-10 sm:right-[30px] md:right-[65px] lg:right-[100px]",
      size: "h-[95px] w-[95px] sm:h-[130px] sm:w-[130px] md:h-[165px] md:w-[165px] lg:h-[200px] lg:w-[200px] rotate-12 opacity-90",
    },
    {
      d: 0.6,
      className:
        "absolute top-[45%] z-2 left-[8%] sm:left-[15%] md:left-[20%] lg:left-75",
      size: "h-[60px] w-[60px] sm:h-[75px] sm:w-[75px] md:h-[90px] md:w-[90px] lg:h-[100px] lg:w-[100px] opacity-90 rotate-45",
    },
    {
      d: 0.7,
      className:
        "absolute z-2 bottom-[18%] right-[10%] sm:right-[18%] md:right-[24%] lg:bottom-50 lg:right-60",
